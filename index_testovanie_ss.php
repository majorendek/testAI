	        ...
	        $( document ).ready(function() {
					   ...
					   $('#rocnikID').on('change', function (e) {
						    ...
						    var valueSelected = this.value;						    
									...
									//generate options
									for (const testik in testSSObj[valueSelected]) { 
									  $('#powerID').append('<option value="' + testik + '">' + testSSObj[valueSelected][testik] + '</option>');
									}			

						 });
							
						$('#rocnikID').val('2').trigger('change');
    ...
    <body>
        ...
        <div class="container-fluid mt-5">
            <div class="row mb-5">
            	...
            	<div class="row mb-5">
            		<h3 class="text-center mb-3 w-100">Vyber si svoj ročník strednej školy</h3>
