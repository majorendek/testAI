				...
				if (!connectDB_PDO()){
						...
						$userID = $decodedJSON["data"]["id"];
							...
							$host = gethostbyaddr($ip);
								...
								fncPDOUserLog($userID,$myCallURL,$myOs,$myOsVersion,$myBrowser,$myBrowserVersion,$myEngine,$myDevice,$myDeviceType,$myDeviceVendor,$myUserAgent,$myResolution,$myColorDepth,$ip,$host);
